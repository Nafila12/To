...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalFormRegister">
                Register
            </button>
    ...
    $(document).ready(function() {
        ...
        $('#modalFormProdukTitipan').on('show.bs.modal', function(e) {
            ...
            if (mode === 'edit') {
                ...
                modal.find('form').attr('action', '{{ url("register") }}/' + id)
                ...
                modal.find('form').attr('action', '{{ url("register") }}')
            }
        })
    });
</script>
