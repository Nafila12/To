...
<head>
    ...
    <!-- <link rel="stylesheet" href="{{ asset('bootsrapt5') }}/css/bootstrap.min.css"> -->
    <link rel="stylesheet" href="{{ asset('sweetalert') }}/sweetalert2.min.css">
    <script src="{{ asset('admin/js/sweetalert211.js') }}"></script>
...
<body>
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1" style="text-decoration: none;">
            ...
            <li class="menu-item">
                <a href="{{ url('/jenis') }}" class="menu-link">
                    ...
                    <div data-i18n="Dashboards">Jenis</div>
                </a>
            </li>
